...
function segment(p1,p2,p0,color="black",taille="1"){
	recalibrage_coord(p1,p0[0],p0[1]);
	recalibrage_coord(p2,p0[0],p0[1]);
	graphe.beginPath();
	graphe.lineWidth=taille;
	graphe.strokeStyle=color;
	graphe.moveTo(p1[0],p1[1]);
	graphe.lineTo(p2[0],p2[1]);
	graphe.stroke();
	recalibrage_inverse(p1,p0[0],p0[1]);
	recalibrage_inverse(p2,p0[0],p0[1]);
}

function dessine_axes(p0,hauteur,longeur,nom_axe_ab,nom_axe_or){
	graphe.beginPath();
	graphe.lineWidth="1";
	graphe.strokeStyle="black";
	graphe.fillStyle="black";
	graphe.moveTo(p0[0],p0[1]);
	graphe.lineTo(p0[0]+longeur,p0[1]);
	graphe.moveTo(p0[0]+longeur,p0[1]);
	graphe.lineTo(p0[0]+longeur-15,p0[1]-10);
	graphe.moveTo(p0[0]+longeur,p0[1]);
	graphe.lineTo(p0[0]+longeur-15,p0[1]+10);
	graphe.moveTo(p0[0],p0[1]);
	graphe.lineTo(p0[0],p0[1]-hauteur);
	graphe.moveTo(p0[0],p0[1]-hauteur);
	graphe.lineTo(p0[0]+10,p0[1]-hauteur+15);
	graphe.moveTo(p0[0],p0[1]-hauteur);
	graphe.lineTo(p0[0]-10,p0[1]-hauteur+15);
	graphe.fillText(nom_axe_or,45,45);
	graphe.fillText(nom_axe_ab,zone_dessin.width-45,zone_dessin.height-45);
	graphe.stroke();
}

function erase(longeur,hauteur){
	graphe.beginPath();
	graphe.fillStyle="white";
	graphe.fillRect(0,0,longeur,hauteur);
}
...
erase(zone_dessin.width,zone_dessin.height);
dessine_axes(p0,zone_dessin.height-60,zone_dessin.width-60,"temps","distance");
