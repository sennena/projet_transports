...
function graph_dist_temps(mat, Vmoy, dist, nb_train, nbr_segment) {
    var repetition = Math.max(nb_train,10);
    for (var k=0; k<repetition; k++) {
        graph(mat,Vmoy,dist,k,nbr_segment);
    }
}